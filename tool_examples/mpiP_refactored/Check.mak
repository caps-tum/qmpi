...
site.exp: ./config.status Makefile
	...
	@echo "set host_os darwin17.7.0" >> ./tmp0
	@echo "set host_alias unreliable" >> ./tmp0
	@echo "set host_cpu x86_64" >> ./tmp0
	@echo "set host_vendor apple" >> ./tmp0
	@echo "set target_os darwin17.7.0" >> ./tmp0
	@echo "set target_alias " >> ./tmp0
	@echo "set target_cpu x86_64" >> ./tmp0
	@echo "set target_vendor apple" >> ./tmp0
	@echo "set host_triplet x86_64-apple-darwin17.7.0" >> ./tmp0
	@echo "set target_triplet x86_64-apple-darwin17.7.0">>./tmp0
